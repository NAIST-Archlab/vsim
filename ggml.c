...
inline static void ggml_vec_dot_q4_0(const int n, float * restrict s, const void * restrict x, const void * restrict y) { /* šššššššš */
  const int nb = n / QK;
  ...
  monitor_time_start(0, T_VEC_DOT_Q4_0); /* Nakashima */
  // scalar
  for (int i = 0; i < nb; i++) {
  ...
  monitor_time_end(0, T_VEC_DOT_Q4_0); /* Nakashima */
...
struct ggml_context * ggml_init(struct ggml_init_params params) {
  ...
  if (is_first_call) {
    ...
    {
      monitor_time_start(0, T_INIT_GELU); /* Nakashima */
      ggml_fp16_t ii;
	...
	table_exp_f16[i]  = GGML_FP32_TO_FP16(exp(f));
      ...
      monitor_time_end(0, T_INIT_GELU); /* Nakashima */
    }

    // initialize g_state
    {
      monitor_time_start(0, T_INIT_GSTAT); /* Nakashima */
	...
	g_state.contexts[i].used = false;
      ...
      monitor_time_end(0, T_INIT_GSTAT); /* Nakashima */
    }
...
static void ggml_compute_forward_mul_mat_f32(
  ...
  const struct ggml_tensor * src1,
  struct ggml_tensor * dst) {
  int64_t t0 = 0;//ggml_perf_time_us();
...
static void ggml_compute_forward_mul_mat_q4_0_f32( /* šššššššš */
  const struct ggml_compute_params * params,
  const struct ggml_tensor * src0,
  const struct ggml_tensor * src1,
  struct ggml_tensor * dst) {
  ...
  if (ggml_compute_forward_mul_mat_use_blas(src0, src1, dst)) {
    ...
    monitor_time_start(0, T_COMPUTE_FORWARD_MUL_MAT_Q4_0_F32_ACC); /* Nakashima */
    for (int i03 = 0; i03 < ne03; i03++) {
      for (int i02 = 0; i02 < ne02; i02++) {
	{
	  int id = 0;
    ...
    monitor_time_end(0, T_COMPUTE_FORWARD_MUL_MAT_Q4_0_F32_ACC); /* Nakashima */
    return;
  }
#endif
  ...
  if (params->type == GGML_TASK_INIT) {
    ...
    if (nb01 >= nb00) {
      ...
      monitor_time_start(0, T_COMPUTE_FORWARD_MUL_MAT_Q4_0_F32_INI); /* Nakashima */
      for (int i13 = 0; i13 < ne13; ++i13) {
	for (int i12 = 0; i12 < ne12; ++i12) {
	  for (int i11 = 0; i11 < ne11; ++i11) {
      ...
      monitor_time_end(0, T_COMPUTE_FORWARD_MUL_MAT_Q4_0_F32_INI); /* Nakashima */
  ...
  if (params->type == GGML_TASK_FINALIZE) {
    ...
    monitor_time_start(0, T_COMPUTE_FORWARD_MUL_MAT_Q4_0_F32_FIN); /* Nakashima */
    ggml_vec_cpy_f32(ic1 - ic0, (float *) dst->data + ic0, wdata + ic0);

    for (int k = 1; k < nth; k++) {
      ggml_vec_acc_f32(ic1 - ic0, (float *) dst->data + ic0, wdata + (ne + CACHE_LINE_SIZE_F32)*k + ic0);
    }
    monitor_time_end(0, T_COMPUTE_FORWARD_MUL_MAT_Q4_0_F32_FIN); /* Nakashima */
  ...
  if (nb01 >= nb00) {
#if 0
    monitor_time_start(0, T_COMPUTE_FORWARD_MUL_MAT_Q4_0_F32_NB01_GE_NB00); /* Nakashima */
    // TODO: do not support transposed src1
    ...
    monitor_time_end(0, T_COMPUTE_FORWARD_MUL_MAT_Q4_0_F32_NB01_GE_NB00); /* Nakashima */
#else
    monitor_time_start(0, IMAX_COMPUTE_FORWARD_MUL_MAT_Q4_0_F32_NB01_GE_NB00); /* Nakashima */
    imax_ggml_compute_forward_mul_mat_q4_0_f32(/*THREAD*/0, /*LANE*/0, params, src0, src1, dst); /* šššššššš */
    monitor_time_end(0, IMAX_COMPUTE_FORWARD_MUL_MAT_Q4_0_F32_NB01_GE_NB00); /* Nakashima */
#endif
  } else {
    // total columns in src1
    const int nc = ne10;
    ...
    monitor_time_start(0, T_COMPUTE_FORWARD_MUL_MAT_Q4_0_F32_NB01_LT_NB00); /* Nakashima */
    for (int i13 = 0; i13 < ne13; ++i13) {
      for (int i12 = 0; i12 < ne12; ++i12) {
	for (int i11 = 0; i11 < ne11; ++i11) {
	  // dst indices
    ...
    monitor_time_end(0, T_COMPUTE_FORWARD_MUL_MAT_Q4_0_F32_NB01_LT_NB00); /* Nakashima */
  }
}
...
static void ggml_compute_forward_mul_mat(
  ...
  switch (src0->type) {
  case GGML_TYPE_Q4_0:
    monitor_time_start(0, T_COMPUTE_FORWARD_MUL_MAT_Q4_0_F32); /* Nakashima */
    ggml_compute_forward_mul_mat_q4_0_f32(params, src0, src1, dst); /* šššššššš */
    monitor_time_end(0, T_COMPUTE_FORWARD_MUL_MAT_Q4_0_F32); /* Nakashima */
    break;
  case GGML_TYPE_Q4_1:
    monitor_time_start(0, T_COMPUTE_FORWARD_MUL_MAT_Q4_1_F32); /* Nakashima */
    ggml_compute_forward_mul_mat_q4_1_f32(params, src0, src1, dst); /* šššššššš */
    monitor_time_end(0, T_COMPUTE_FORWARD_MUL_MAT_Q4_1_F32); /* Nakashima */
    break;
  case GGML_TYPE_F16:
    monitor_time_start(0, T_COMPUTE_FORWARD_MUL_MAT_F16_F32); /* Nakashima */
    ggml_compute_forward_mul_mat_f16_f32(params, src0, src1, dst);  /* šššššššš */
    monitor_time_end(0, T_COMPUTE_FORWARD_MUL_MAT_F16_F32); /* Nakashima */
    break;
  case GGML_TYPE_F32:
    monitor_time_start(0, T_COMPUTE_FORWARD_MUL_MAT_F32); /* Nakashima */
    ggml_compute_forward_mul_mat_f32(params, src0, src1, dst);      /* šššššššš */
    monitor_time_end(0, T_COMPUTE_FORWARD_MUL_MAT_F32); /* Nakashima */
    break;
  case GGML_TYPE_I8:
  case GGML_TYPE_I16:
  case GGML_TYPE_I32:
...
static void ggml_compute_forward(struct ggml_compute_params * params, struct ggml_tensor * tensor) {
  ...
  monitor_time_start(0, T_COMPUTE_FORWARD); /* Nakashima */
  
  switch (tensor->op) {
  case GGML_OP_DUP:
    monitor_time_start(0, T_COMPUTE_FORWARD_DUP); /* Nakashima */
    ggml_compute_forward_dup(params, tensor->src0, tensor);
    monitor_time_end(0, T_COMPUTE_FORWARD_DUP); /* Nakashima */
    break;
  case GGML_OP_ADD:
    monitor_time_start(0, T_COMPUTE_FORWARD_ADD); /* Nakashima */
    ggml_compute_forward_add(params, tensor->src0, tensor->src1, tensor);
    monitor_time_end(0, T_COMPUTE_FORWARD_ADD); /* Nakashima */
    break;
  case GGML_OP_SUB:
    monitor_time_start(0, T_COMPUTE_FORWARD_SUB); /* Nakashima */
    ggml_compute_forward_sub(params, tensor->src0, tensor->src1, tensor);
    monitor_time_end(0, T_COMPUTE_FORWARD_SUB); /* Nakashima */
    break;
  case GGML_OP_MUL:
    monitor_time_start(0, T_COMPUTE_FORWARD_MUL); /* Nakashima */
    ggml_compute_forward_mul(params, tensor->src0, tensor->src1, tensor);
    monitor_time_end(0, T_COMPUTE_FORWARD_MUL); /* Nakashima */
    break;
  case GGML_OP_DIV:
    monitor_time_start(0, T_COMPUTE_FORWARD_DIV); /* Nakashima */
    ggml_compute_forward_div(params, tensor->src0, tensor->src1, tensor);
    monitor_time_end(0, T_COMPUTE_FORWARD_DIV); /* Nakashima */
    break;
  case GGML_OP_SQR:
    monitor_time_start(0, T_COMPUTE_FORWARD_SQR); /* Nakashima */
    ggml_compute_forward_sqr(params, tensor->src0, tensor);
    monitor_time_end(0, T_COMPUTE_FORWARD_SQR); /* Nakashima */
    break;
  case GGML_OP_SQRT:
    monitor_time_start(0, T_COMPUTE_FORWARD_SQRT); /* Nakashima */
    ggml_compute_forward_sqrt(params, tensor->src0, tensor);
    monitor_time_end(0, T_COMPUTE_FORWARD_SQRT); /* Nakashima */
    break;
  case GGML_OP_SUM:
    monitor_time_start(0, T_COMPUTE_FORWARD_SUM); /* Nakashima */
    ggml_compute_forward_sum(params, tensor->src0, tensor);
    monitor_time_end(0, T_COMPUTE_FORWARD_SUM); /* Nakashima */
    break;
  case GGML_OP_MEAN:
    monitor_time_start(0, T_COMPUTE_FORWARD_MEAN); /* Nakashima */
    ggml_compute_forward_mean(params, tensor->src0, tensor);
    monitor_time_end(0, T_COMPUTE_FORWARD_MEAN); /* Nakashima */
    break;
  case GGML_OP_REPEAT:
    monitor_time_start(0, T_COMPUTE_FORWARD_REPEAT); /* Nakashima */
    ggml_compute_forward_repeat(params, tensor->src0, tensor);
    monitor_time_end(0, T_COMPUTE_FORWARD_REPEAT); /* Nakashima */
    break;
  case GGML_OP_ABS:
    monitor_time_start(0, T_COMPUTE_FORWARD_ABS); /* Nakashima */
    ggml_compute_forward_abs(params, tensor->src0, tensor);
    monitor_time_end(0, T_COMPUTE_FORWARD_ABS); /* Nakashima */
    break;
  case GGML_OP_SGN:
    monitor_time_start(0, T_COMPUTE_FORWARD_SGN); /* Nakashima */
    ggml_compute_forward_sgn(params, tensor->src0, tensor);
    monitor_time_end(0, T_COMPUTE_FORWARD_SGN); /* Nakashima */
    break;
  case GGML_OP_NEG:
    monitor_time_start(0, T_COMPUTE_FORWARD_NEG); /* Nakashima */
    ggml_compute_forward_neg(params, tensor->src0, tensor);
    monitor_time_end(0, T_COMPUTE_FORWARD_NEG); /* Nakashima */
    break;
  case GGML_OP_STEP:
    monitor_time_start(0, T_COMPUTE_FORWARD_STEP); /* Nakashima */
    ggml_compute_forward_step(params, tensor->src0, tensor);
    monitor_time_end(0, T_COMPUTE_FORWARD_STEP); /* Nakashima */
    break;
  case GGML_OP_RELU:
    monitor_time_start(0, T_COMPUTE_FORWARD_RELU); /* Nakashima */
    ggml_compute_forward_relu(params, tensor->src0, tensor);
    monitor_time_end(0, T_COMPUTE_FORWARD_RELU); /* Nakashima */
    break;
  case GGML_OP_GELU:
    monitor_time_start(0, T_COMPUTE_FORWARD_GELU); /* Nakashima */
    ggml_compute_forward_gelu(params, tensor->src0, tensor);
    monitor_time_end(0, T_COMPUTE_FORWARD_GELU); /* Nakashima */
    break;
  case GGML_OP_SILU:
    monitor_time_start(0, T_COMPUTE_FORWARD_SILU); /* Nakashima */
    ggml_compute_forward_silu(params, tensor->src0, tensor);
    monitor_time_end(0, T_COMPUTE_FORWARD_SILU); /* Nakashima */
    break;
  case GGML_OP_NORM:
    monitor_time_start(0, T_COMPUTE_FORWARD_NORM); /* Nakashima */
    ggml_compute_forward_norm(params, tensor->src0, tensor);
    monitor_time_end(0, T_COMPUTE_FORWARD_NORM); /* Nakashima */
    break;
  case GGML_OP_MUL_MAT:
    monitor_time_start(0, T_COMPUTE_FORWARD_MUL_MAT); /* Nakashima */
    ggml_compute_forward_mul_mat(params, tensor->src0, tensor->src1, tensor);
    monitor_time_end(0, T_COMPUTE_FORWARD_MUL_MAT); /* Nakashima */
    break;
  case GGML_OP_SCALE:
    monitor_time_start(0, T_COMPUTE_FORWARD_SCALE); /* Nakashima */
    ggml_compute_forward_scale(params, tensor->src0, tensor->src1, tensor);
    monitor_time_end(0, T_COMPUTE_FORWARD_SCALE); /* Nakashima */
    break;
  case GGML_OP_CPY:
    monitor_time_start(0, T_COMPUTE_FORWARD_CPY); /* Nakashima */
    ggml_compute_forward_cpy(params, tensor->src0, tensor);
    monitor_time_end(0, T_COMPUTE_FORWARD_CPY); /* Nakashima */
    break;
  case GGML_OP_RESHAPE:
    monitor_time_start(0, T_COMPUTE_FORWARD_RESHAPE); /* Nakashima */
    ggml_compute_forward_reshape(params, tensor->src0, tensor);
    monitor_time_end(0, T_COMPUTE_FORWARD_RESHAPE); /* Nakashima */
    break;
  case GGML_OP_VIEW:
    monitor_time_start(0, T_COMPUTE_FORWARD_VIEW); /* Nakashima */
    ggml_compute_forward_view(params, tensor->src0);
    monitor_time_end(0, T_COMPUTE_FORWARD_VIEW); /* Nakashima */
    break;
  case GGML_OP_PERMUTE:
    monitor_time_start(0, T_COMPUTE_FORWARD_PERMUTE); /* Nakashima */
    ggml_compute_forward_permute(params, tensor->src0);
    monitor_time_end(0, T_COMPUTE_FORWARD_PERMUTE); /* Nakashima */
    break;
  case GGML_OP_TRANSPOSE:
    monitor_time_start(0, T_COMPUTE_FORWARD_TRANSPOSE); /* Nakashima */
    ggml_compute_forward_transpose(params, tensor->src0);
    monitor_time_end(0, T_COMPUTE_FORWARD_TRANSPOSE); /* Nakashima */
    break;
  case GGML_OP_GET_ROWS:
    monitor_time_start(0, T_COMPUTE_FORWARD_GET_ROWS); /* Nakashima */
    ggml_compute_forward_get_rows(params, tensor->src0, tensor->src1, tensor);
    monitor_time_end(0, T_COMPUTE_FORWARD_GET_ROWS); /* Nakashima */
    break;
  case GGML_OP_DIAG_MASK_INF:
    monitor_time_start(0, T_COMPUTE_FORWARD_DIAG_MASK_INF); /* Nakashima */
    ggml_compute_forward_diag_mask_inf(params, tensor->src0, tensor->src1, tensor);
    monitor_time_end(0, T_COMPUTE_FORWARD_DIAG_MASK_INF); /* Nakashima */
    break;
  case GGML_OP_SOFT_MAX:
    monitor_time_start(0, T_COMPUTE_FORWARD_SOFT_MAX); /* Nakashima */
    ggml_compute_forward_soft_max(params, tensor->src0, tensor);
    monitor_time_end(0, T_COMPUTE_FORWARD_SOFT_MAX); /* Nakashima */
    break;
  case GGML_OP_ROPE:
    monitor_time_start(0, T_COMPUTE_FORWARD_ROPE); /* Nakashima */
    ggml_compute_forward_rope(params, tensor->src0, tensor->src1, tensor);
    monitor_time_end(0, T_COMPUTE_FORWARD_ROPE); /* Nakashima */
    break;
  case GGML_OP_GPTNEOX_ROPE:
    monitor_time_start(0, T_COMPUTE_FORWARD_GPTNEOX_ROPE); /* Nakashima */
    ggml_compute_forward_gptneox_rope(params, tensor->src0, tensor->src1, tensor);
    monitor_time_end(0, T_COMPUTE_FORWARD_GPTNEOX_ROPE); /* Nakashima */
    break;
  case GGML_OP_ALIBI:
    monitor_time_start(0, T_COMPUTE_FORWARD_ALIBI); /* Nakashima */
    ggml_compute_forward_alibi(params, tensor->src0, tensor->src1, tensor);
    monitor_time_end(0, T_COMPUTE_FORWARD_ALIBI); /* Nakashima */
    break;
  case GGML_OP_CONV_1D_1S:
    monitor_time_start(0, T_COMPUTE_FORWARD_CONV_1D_1S); /* Nakashima */
    ggml_compute_forward_conv_1d_1s(params, tensor->src0, tensor->src1, tensor);
    monitor_time_end(0, T_COMPUTE_FORWARD_CONV_1D_1S); /* Nakashima */
    break;
  case GGML_OP_CONV_1D_2S:
    monitor_time_start(0, T_COMPUTE_FORWARD_CONV_1D_2S); /* Nakashima */
    ggml_compute_forward_conv_1d_2s(params, tensor->src0, tensor->src1, tensor);
    monitor_time_end(0, T_COMPUTE_FORWARD_CONV_1D_2S); /* Nakashima */
    break;
  case GGML_OP_FLASH_ATTN:
    { int32_t t = ggml_get_i32_1d(tensor->opt[1], 0);
    GGML_ASSERT(t == 0 || t == 1);
    bool masked = t != 0;
    monitor_time_start(0, T_COMPUTE_FORWARD_FLASH_ATTN); /* Nakashima */
    ggml_compute_forward_flash_attn(params, tensor->src0, tensor->src1, tensor->opt[0], masked, tensor);
    monitor_time_end(0, T_COMPUTE_FORWARD_FLASH_ATTN); /* Nakashima */
    }
  break;
  case GGML_OP_FLASH_FF:
    monitor_time_start(0, T_COMPUTE_FORWARD_FLASH_FF); /* Nakashima */
    ggml_compute_forward_flash_ff(params, tensor->src0, tensor->src1, tensor->opt[0], tensor->opt[1], tensor->opt[2], tensor);
    monitor_time_end(0, T_COMPUTE_FORWARD_FLASH_FF); /* Nakashima */
    break;
  case GGML_OP_NONE:
    // nop
	 break;
  ...
  monitor_time_end(0, T_COMPUTE_FORWARD); /* Nakashima */
}
...
void ggml_graph_compute(struct ggml_context * ctx, struct ggml_cgraph * cgraph) {
  ...
  monitor_time_start(0, T_COMPUTE_INIT); /* Nakashima */
  ...
  monitor_time_end(0, T_COMPUTE_INIT); /* Nakashima */

  const int64_t perf_start_cycles  = 0;//ggml_perf_cycles();
  const int64_t perf_start_time_us = 0;//ggml_perf_time_us();

  monitor_time_start(0, T_COMPUTE_NODES); /* Nakashima */
  ...
  for (int i = 0; i < cgraph->n_nodes; i++) {
    ...
    const int64_t perf_node_start_cycles  = 0;//ggml_perf_cycles();
    const int64_t perf_node_start_time_us = 0;//ggml_perf_time_us();
    ...
    {
      int64_t perf_cycles_cur  = 0;//ggml_perf_cycles()  - perf_node_start_cycles;
      int64_t perf_time_us_cur = 0;//ggml_perf_time_us() - perf_node_start_time_us;
  ...
  monitor_time_end(0, T_COMPUTE_NODES); /* Nakashima */
  ...
  {
    int64_t perf_cycles_cur  = 0;//ggml_perf_cycles()  - perf_start_cycles;
    int64_t perf_time_us_cur = 0;//ggml_perf_time_us() - perf_start_time_us;
...
static enum ggml_opt_result ggml_opt_adam(
  ...
  for (int t = 0; t < params.adam.n_iter; ++t) {
    ...
    monitor_time_start(0, T_OPT); /* Nakashima */
    {
      // update the gradient
    ...
    {
      monitor_time_end(0, T_OPT); /* Nakashima */
    }
  }
